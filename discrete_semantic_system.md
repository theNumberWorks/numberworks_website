...
<i class='fa fa-file-text'></i> Lengyel, G., & Krajcsi, A. (2025). No observable SNARC effect with numbers in nonsymbolic format. Journal of Experimental Psychology: Human Perception and Performance. Read the [preprint](https://osf.io/preprints/psyarxiv/2c9kr) or the [accepted version of the manuscript](https://github.com/GaborLengyel/dot-SNARC/blob/main/DotSNARC_JEPH_accepted.pdf).
